...
DEFAULT_FAMILY = "SeedKRex"


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Create a distribution ZIP from built SeedKRex OTF files."
    )
    parser.add_argument(
        "--input-dir",
        default="instance_otf",
        help="Directory containing built SeedKRex OTF files",
    )
    parser.add_argument(
        "--output-dir",
        default="dist",
    ...
    parser.add_argument(
        "--zip-name",
        help="Optional ZIP filename; defaults to SeedKRex-otf-YYYYMMDD.zip",
    )
    parser.add_argument(
        "--family-name",
